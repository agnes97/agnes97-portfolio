...
const Uisk: FC = () => (
  <Flex flexDirection='column' gap='1rem'>
    <p>
      I've been granted a scholarship on the grounds of helping with management
      and administration of Library and Information Science department under the
      Faculty of Arts of Charles University in Prague. I started just two months
      after the beginning of my first semester and continued for the whole
      period of my undergraduate studies. The position is open for only two to
      three students every year.
    </p>
    ...
    <p>
      ...
      online and printed documents with occasional graphic work in Photoshop for
      social sites (events, promotions, even vector logos).
    </p>
    ...
    <p>
      ...
      Microsoft's Office 365 package (Word, Excel, PowerPoint) and online tools
      such as Doodle, Trello and others.
    </p>
